        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fields = table.Column<string>(name: "Fields)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestsTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RequestsTypes_Departments_DepartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Operators_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProcessingStartDate = table.Column<DateTime>(nullable: false),
                    ProcessingEndDate = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Requests_RequestsTypes_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestsTypes_DepartmentId",
                table: "RequestsTypes",
                column: "DepartmentId",
                unique: true);
